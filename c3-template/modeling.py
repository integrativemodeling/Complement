...
bm1.set_coordinates("MG6beta_MG7_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["MG6beta"], terminus="C", resolution=1))
bm1.set_coordinates("MG7_CUBf_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["MG7"], terminus="C", resolution=1))
bm1.set_coordinates("CUBf_TED_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["CUBf"], terminus="C", resolution=1))
bm1.set_coordinates("TED_CUBg_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["TED"], terminus="C", resolution=1))
bm1.set_coordinates("CUBg_MG8_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["CUBg"], terminus="C", resolution=1))
bm1.set_coordinates("MG8_Anchor_Link",IMP.pmi.tools.get_position_terminal_residue(simo1,bm1.domain_dict["MG8"], terminus="C", resolution=1))
